...
$pdf->Cell(0, 13, 'Laporan Data Perbaikan Asset ', '0', 1, 'C');
...
$pdf->Cell(45, 7, 'Nama Barang', 1, '0', 'C', true);
$pdf->Cell(45, 7, 'Kerusakan', 1, '0', 'C', true);
$pdf->Cell(55, 7, 'Spot area', 1, '0', 'C', true);
$pdf->Cell(35, 7, 'Status perbaikan', 1, '0', 'C', true);
$pdf->Ln();
...
$pdf->SetTextColor(0);
$i = 0;
$tampil = mysqli_query($koneksi, "SELECT * FROM maintenance_yayas order by nama_barang ASC");
while ($data = mysqli_fetch_array($tampil)) {
    $i++;
    $pdf->Cell(8, 7, $i, 1, '0', 'C', true);
    $pdf->Cell(45, 7, $data['nama_barang'], 1, '0', 'L', true);
    $pdf->Cell(45, 7, $data['jenis_kerusakan'], 1, '0', 'L', true);
    $pdf->Cell(55, 7, $data['spot_area'], 1, '0', 'L', true);
    $pdf->Cell(35, 7, $data['status_perbaikan'], 1, '0', 'L', true);
    $pdf->Ln();
}
// Menampilkan output file PDF
$pdf->Output('i', 'Laporan Data Perbaikan Asset Keseluruhan.pdf', 'false');
